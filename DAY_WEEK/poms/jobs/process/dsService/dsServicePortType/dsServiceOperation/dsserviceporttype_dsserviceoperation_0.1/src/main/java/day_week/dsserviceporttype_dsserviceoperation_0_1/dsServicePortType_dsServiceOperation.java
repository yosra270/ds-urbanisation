...
package day_week.dsserviceporttype_dsserviceoperation_0_1;
...
/**
 * Job: dsServicePortType_dsServiceOperation Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class dsServicePortType_dsServiceOperation implements TalendJob {
	...
	private final String jobName = "dsServicePortType_dsServiceOperation";
	private final String projectName = "DAY_WEEK";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					dsServicePortType_dsServiceOperation.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dsServicePortType_dsServiceOperation.this,
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final dsServicePortType_dsServiceOperation job;

		public RestServiceProviderImpl4TalendJob(dsServicePortType_dsServiceOperation job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap,
				dsServicePortType_dsServiceOperation job) {
		...
		@javax.ws.rs.Path("/month")
		@javax.ws.rs.Produces({ "application/xml", "text/xml", "application/json" })
		public javax.ws.rs.core.Response monthOfYear(

				@javax.ws.rs.QueryParam("monthNumber") Integer monthNumber
			...
			request_tRESTRequest_1.put("OPERATION", "monthOfYear");
			request_tRESTRequest_1.put("PATTERN", "/month");
			...
			parameters_tRESTRequest_1.put("QUERY:monthNumber:id_Integer", monthNumber);
		...
		@javax.ws.rs.Path("/day")
		@javax.ws.rs.Produces({ "application/xml", "text/xml", "application/json" })
		public javax.ws.rs.core.Response dayOfWeek(

				@javax.ws.rs.QueryParam("dayNumber") Integer dayNumber

		) {
			java.util.Map<String, Object> request_tRESTRequest_1 = new java.util.HashMap<String, Object>();
			request_tRESTRequest_1.put("VERB", "GET");
			request_tRESTRequest_1.put("OPERATION", "dayOfWeek");
			request_tRESTRequest_1.put("PATTERN", "/day");

			populateRequestInfo(request_tRESTRequest_1, messageContext);

			java.util.Map<String, Object> parameters_tRESTRequest_1 = new java.util.HashMap<String, Object>();

			parameters_tRESTRequest_1.put("QUERY:dayNumber:id_Integer", dayNumber);
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(dsServicePortType_dsServiceOperation job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = dsServicePortType_dsServiceOperation.class.getClassLoader()
					.getResourceAsStream(
							"day_week/dsserviceporttype_dsserviceoperation_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = dsServicePortType_dsServiceOperation.class.getClassLoader()
	...
	public static class output_monthOfYearStruct implements routines.system.IPersistableRow<output_monthOfYearStruct> {
		final static byte[] commonByteArrayLock_DAY_WEEK_dsServicePortType_dsServiceOperation = new byte[0];
		static byte[] commonByteArray_DAY_WEEK_dsServicePortType_dsServiceOperation = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DAY_WEEK_dsServicePortType_dsServiceOperation) {
		 ...
		 * Compare keys
		 */
		public int compareTo(output_monthOfYearStruct other) {
	...
	public static class output_dayOfWeekStruct implements routines.system.IPersistableRow<output_dayOfWeekStruct> {
		final static byte[] commonByteArrayLock_DAY_WEEK_dsServicePortType_dsServiceOperation = new byte[0];
		static byte[] commonByteArray_DAY_WEEK_dsServicePortType_dsServiceOperation = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(output_dayOfWeekStruct other) {
	...
	public static class dayOfWeekStruct implements routines.system.IPersistableRow<dayOfWeekStruct> {
		final static byte[] commonByteArrayLock_DAY_WEEK_dsServicePortType_dsServiceOperation = new byte[0];
		static byte[] commonByteArray_DAY_WEEK_dsServicePortType_dsServiceOperation = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DAY_WEEK_dsServicePortType_dsServiceOperation) {
				...
				try {
					...
					this.dayNumber = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.dayNumber, dos);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("dayNumber=" + String.valueOf(dayNumber));
			sb.append("]");
		 ...
		 * Compare keys
		 */
		public int compareTo(dayOfWeekStruct other) {
	...
	public static class monthOfYearStruct implements routines.system.IPersistableRow<monthOfYearStruct> {
		final static byte[] commonByteArrayLock_DAY_WEEK_dsServicePortType_dsServiceOperation = new byte[0];
		static byte[] commonByteArray_DAY_WEEK_dsServicePortType_dsServiceOperation = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(monthOfYearStruct other) {
	...
	public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				dayOfWeekStruct dayOfWeek = new dayOfWeekStruct();
				output_dayOfWeekStruct output_dayOfWeek = new output_dayOfWeekStruct();
				monthOfYearStruct monthOfYear = new monthOfYearStruct();
				output_monthOfYearStruct output_monthOfYear = new output_monthOfYearStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(iterateId, 0, 0, "dayOfWeek", "output_dayOfWeek", "monthOfYear",
							"output_monthOfYear");
				}
				...
				try {
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "output_dayOfWeek");
					}
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "dayOfWeek");
					}
...
// # Outputs initialization
					output_dayOfWeekStruct output_dayOfWeek_tmp = new output_dayOfWeekStruct();
					output_dayOfWeekStruct output_dayOfWeek_save = null;
// ###############################
					int nb_line_tXMLMap_1 = 0;

					XML_API_tXMLMap_1 xml_api_tXMLMap_1 = new XML_API_tXMLMap_1();

					class GenerateDocument_output_dayOfWeek {
						...
						public GenerateDocument_output_dayOfWeek() {
//    	this.treeNodeAPI = treeNodeAPI;
						...
						// input table.
						void generateElements(boolean isInnerJoin, dayOfWeekStruct dayOfWeek,
...
// build root xml tree 
							if (needRoot) {
								...
								root_0 = root.addElement("dayNumber");
								valueMap.put("root_0",
										dayOfWeek.dayNumber == 1 ? "Monday"
												: (dayOfWeek.dayNumber == 2 ? "Tuesday"
														: (dayOfWeek.dayNumber == 3 ? "Wednesday"
																: (dayOfWeek.dayNumber == 4 ? "Thursday"
																		: (dayOfWeek.dayNumber == 5 ? "Friday"
																				: (dayOfWeek.dayNumber == 6 ? "Saturday"
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "output_monthOfYear");
					}
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "monthOfYear");
					}
...
// ###############################
// # Outputs initialization
					output_monthOfYearStruct output_monthOfYear_tmp = new output_monthOfYearStruct();
					output_monthOfYearStruct output_monthOfYear_save = null;
// ###############################
					int nb_line_tXMLMap_2 = 0;

					XML_API_tXMLMap_2 xml_api_tXMLMap_2 = new XML_API_tXMLMap_2();

					class GenerateDocument_output_monthOfYear {
						...
						public GenerateDocument_output_monthOfYear() {
//    	this.treeNodeAPI = treeNodeAPI;
						...
						// We generate the TreeNode_API object only if there is a document in the main
						// input table.
						void generateElements(boolean isInnerJoin, monthOfYearStruct monthOfYear,
...
// build root xml tree 
							if (needRoot) {
								...
								subTreeRootParent = root;
								org.dom4j.Element root_0 = null;
								root_0 = root.addElement("monthNumber");
								valueMap.put("root_0", monthOfYear.monthNumber == 1 ? "January"
										: (monthOfYear.monthNumber == 2 ? "February"
												: (monthOfYear.monthNumber == 3 ? "March"
														: (monthOfYear.monthNumber == 4 ? "April"
																: (monthOfYear.monthNumber == 5 ? "May"
																		: (monthOfYear.monthNumber == 6 ? "June"
																				: (monthOfYear.monthNumber == 7 ? "July"
																						: (monthOfYear.monthNumber == 8
																								? "August"
																								: (monthOfYear.monthNumber == 9
																										? "September"
																										: (monthOfYear.monthNumber == 10
																												? "October"
																												: (monthOfYear.monthNumber == 11
																														? "November"
																														: (monthOfYear.monthNumber == 12
																																? "December"
																																: "Error"))))))))))));
								if (valueMap.get("root_0") != null) {
									routines.system.NestXMLTool.setText(root_0,
					...
					if (requestMessage_tRESTRequest_1.containsKey("ERROR")) { // wrong request received
						...
						java.util.Map<String, Object> params_tRESTRequest_1 = (java.util.Map<String, Object>) requestMessage_tRESTRequest_1
								.get("PARAMS");
						if (matchedFlow_tRESTRequest_1.equals("monthOfYear")) {
							monthOfYear = new monthOfYearStruct();
							if (params_tRESTRequest_1.containsKey("QUERY:monthNumber:id_Integer")) {

								monthOfYear.monthNumber = (Integer) params_tRESTRequest_1
										.get("QUERY:monthNumber:id_Integer");
						...
						if (matchedFlow_tRESTRequest_1.equals("dayOfWeek")) {
							dayOfWeek = new dayOfWeekStruct();
							if (params_tRESTRequest_1.containsKey("QUERY:dayNumber:id_Integer")) {

								dayOfWeek.dayNumber = (Integer) params_tRESTRequest_1.get("QUERY:dayNumber:id_Integer");
...
// Start of branch "dayOfWeek"
					if (dayOfWeek != null) {
						...
						GenerateDocument_output_dayOfWeek gen_Doc_output_dayOfWeek_tXMLMap_1 = new GenerateDocument_output_dayOfWeek();
						output_dayOfWeek_tmp.body = null;
						...
						{ // start of Var scope
							...
							output_dayOfWeek = null;

// # Output table : 'output_dayOfWeek'

							gen_Doc_output_dayOfWeek_tXMLMap_1.generateElements(rejectedDocInnerJoin_tXMLMap_1,
									dayOfWeek, Var);

							if (output_dayOfWeek_tmp.body == null) {
								output_dayOfWeek_tmp.body = new routines.system.Document();
								output_dayOfWeek_tmp.body.setDocument(gen_Doc_output_dayOfWeek_tXMLMap_1.getDocument());
							}

							output_dayOfWeek = output_dayOfWeek_tmp;
							output_dayOfWeek_save = output_dayOfWeek_tmp;
// ###############################
						 ...
						 */
// Start of branch "output_dayOfWeek"
						if (output_dayOfWeek != null) {
							...
							if (null == outputStream_tRESTResponse_1 && responseAlreadySent_tRESTResponse_1) {
								...
								if (null != output_dayOfWeek.body) {
									restProviderResponse_tRESTResponse_1 = output_dayOfWeek.body.getDocument();
								}
						...
						} // End of branch "output_dayOfWeek"
					...
					} // End of branch "dayOfWeek"

// Start of branch "monthOfYear"
					if (monthOfYear != null) {
						...
						GenerateDocument_output_monthOfYear gen_Doc_output_monthOfYear_tXMLMap_2 = new GenerateDocument_output_monthOfYear();
						output_monthOfYear_tmp.body = null;
						...
						{ // start of Var scope
							...
							output_monthOfYear = null;

// # Output table : 'output_monthOfYear'

							gen_Doc_output_monthOfYear_tXMLMap_2.generateElements(rejectedDocInnerJoin_tXMLMap_2,
									monthOfYear, Var);

							if (output_monthOfYear_tmp.body == null) {
								output_monthOfYear_tmp.body = new routines.system.Document();
								output_monthOfYear_tmp.body
										.setDocument(gen_Doc_output_monthOfYear_tXMLMap_2.getDocument());
							}

							output_monthOfYear = output_monthOfYear_tmp;
							output_monthOfYear_save = output_monthOfYear_tmp;
// ###############################
						 ...
						 */
// Start of branch "output_monthOfYear"
						if (output_monthOfYear != null) {
							...
							if (null == outputStream_tRESTResponse_2 && responseAlreadySent_tRESTResponse_2) {
								...
								if (null != output_monthOfYear.body) {
									restProviderResponse_tRESTResponse_2 = output_monthOfYear.body.getDocument();
								}
						...
						} // End of branch "output_monthOfYear"
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "dayOfWeek");
					}
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "output_dayOfWeek");
					}
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "monthOfYear");
					}
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "output_monthOfYear");
					}
				...
				if (execStat) {
					runStat.updateStatOnConnection(iterateId, 2, 0, "dayOfWeek", "output_dayOfWeek", "monthOfYear",
							"output_monthOfYear");
				}
	...
	public static void main(String[] args) {
		final dsServicePortType_dsServiceOperation dsServicePortType_dsServiceOperationClass = new dsServicePortType_dsServiceOperation();

		int exitCode = dsServicePortType_dsServiceOperationClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dsServicePortType_dsServiceOperation.class.getClassLoader()
					.getResourceAsStream(
							"day_week/dsserviceporttype_dsserviceoperation_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dsServicePortType_dsServiceOperation.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : dsServicePortType_dsServiceOperation");
		}
...
/************************************************************************************************
 * 100059 characters generated by Talend Open Studio for ESB on the December 6,
 * 2022 at 4:37:34 PM CET
 ************************************************************************************************/